...
from main_qamc_task_specific import (
     LAVENDER_QAMC_TS, Dataset_QAMC_TS, Agent_QAMC_TS)
...
class Dataset_QAMC_MLM(Dataset_QAMC_TS):
...
class LAVENDER_QAMC_MLM(LAVENDER_QAMC_TS):
...
class Agent_QAMC_MLM(Agent_QAMC_TS):
